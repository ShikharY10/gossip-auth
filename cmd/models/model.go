...
type User struct {
	...
	PartnerRequests  map[string]PartnerRequest `bson:"partnerrequests,omitempty" json:"partnerrequests"`
	PartnerRequested map[string]PartnerRequest `bson:"partnerrequested,omitempty" json:"partnerrequested"`
